...
import { AppState } from "../stateManagement/reduxStore";
...
export default function ShoppingCart() {
  ...
  const totalPrice = cart.products.reduce((total, product) => {
    return total + product.price * product.minimumOrderQuantity;
  }, 0);

  // const totalDiscountPercentage = cart.products.reduce((total, product) => {
  //   return total + product.discountPercentage * product.minimumOrderQuantity;
  // }, 0);

  return (
    <section className="h-dvh bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
